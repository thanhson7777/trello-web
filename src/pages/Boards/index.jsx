...
function Boards() {
  ...
  useEffect(() => {
    ...
    // Mỗi khi thay đổi url , thì localtion.search cũng thay đổi (useEffect sẽ fetch lại api theo đúng location.search của page mới vì location.search đã có trong dependenies của useEffect)
