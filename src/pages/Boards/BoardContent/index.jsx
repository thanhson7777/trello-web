    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          ${theme.spacing(5)} - ${COLUMN_HEADER_HEIGHT} - ${COLUMN_HEADER_HEIGHT}
          )`,
            ...
            <Card sx={{
              ...
              <CardMedia
                ...
                alt="green iguana"
                height="140"
                image="https://tse2.mm.bing.net/th/id/OIP.MxChmw-AAIq5pFDu1yKO0QHaEK?pid=Api&P=0&h=220"
                title='this card'
              />
              <CardContent sx={{ p: 1.5, '&:last-child': { p: 1.5 } }}>
                <Typography>Thanh Son</Typography>
              </CardContent>
