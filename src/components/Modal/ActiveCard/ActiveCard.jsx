...
/**
 * Note: Modal là một low-component mà bọn MUI sử dụng bên trong những thứ như Dialog, Drawer, Menu, Popover. Ở đây dĩ nhiên chúng ta có thể sử dụng Dialog cũng không thành vấn đề gì, nhưng sẽ sử dụng Modal để dễ linh hoạt tùy biến giao diện từ con số 0 cho phù hợp với mọi nhu cầu
 */
function ActiveCard() {
  ...
  const callApiUpdateCard = async (updateData) => {
    ...
    // B1: Cập nhật lại card đang active trong modal hiện tại vào trong redux
    dispatch(updateCurrentActiveCard(updatedCard))
    // B2: Cập nhật bản ghi vào trong trong activeBoard (nested data - dữ liệu nằm sâu ở bên trong)
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Nếu user chưa là thành viên của card thì mới hiện join, khi click vào join thì luôn là hành động thêm */}
